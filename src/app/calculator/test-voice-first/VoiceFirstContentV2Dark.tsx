              ...
              <CardContent className="pt-6 sm:pt-8 px-4 sm:px-6">
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    ...
                    <DarkDataField label="Life Expectancy Age" value={longevityAge} editMode={editMode} onEdit={setLongevityAge} type="number" isGlowing={glowingFields.has('longevity_age')} />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                      <DarkDataField label="Desired Monthly Income (Net)" value={monthlySpending} editMode={editMode} onEdit={setMonthlySpending} type="currency" isGlowing={glowingFields.has('monthly_spending')} />
        ...
        {calculationResults && (
          <div className="w-full mt-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              <ResultsSummary results={calculationResults} retirementAge={retirementAge || 65} isDarkMode={true} />
